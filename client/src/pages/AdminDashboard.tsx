...
export default function AdminDashboard() {
  ...
  const removeService = trpc.services.remove.useMutation({
    onSuccess: async () => { await refreshAdminData(); setServiceDraft({ id: 0, name: "", description: "", duration: 45, department: "dentistry" }); toast.success("تم حذف الخدمة"); },
    onError: error => toast.error(error.message || "تعذر حذف الخدمة"),
  });
