  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="sticky top-0 z-40 bg-white border-b border-slate-200 shadow-sm">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-blue-900">إيفان</h1>
              <p className="text-xs text-orange-600 font-semibold">عيادات طبية</p>
            </div>
          </div>
          <nav className="hidden md:flex items-center gap-8">
            <a href="#services" className="text-sm font-medium text-slate-700 hover:text-blue-600 transition-colors">الخدمات</a>
            <a href="#branches" className="text-sm font-medium text-slate-700 hover:text-blue-600 transition-colors">الفروع</a>
            <button
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-400/20 to-green-400/20 rounded-2xl blur-3xl"></div>
      ...
      <section id="services" className="py-20 bg-slate-50">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            <h3 className="text-4xl font-bold text-blue-900 mb-4">خدماتنا</h3>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={service.title} className="bg-white rounded-lg p-8 border-2 border-slate-200 hover:border-blue-600 hover:shadow-lg transition-all duration-200">
      ...
      <section id="branches" className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            <h3 className="text-4xl font-bold text-blue-900 mb-4">فروعنا</h3>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={branch.name} className="bg-gradient-to-br from-blue-50 to-green-50 rounded-lg p-8 border-2 border-blue-200 hover:shadow-lg transition-all duration-200">
